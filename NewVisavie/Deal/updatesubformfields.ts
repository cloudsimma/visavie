try 
{
	if(id != null)
	{
		...
		{
			contactMap = Map();
			if(get_deal.get("Contact_persons") != null)
			{
				data_map = Map();
				ownerName = "lion_visavie";
				appName = "visavie";
				report_name = "All_Contacts";
				for each  subforms in get_deal.get("Contact_persons")
				{
					if(subforms.get("contact") != null)
					{
						...
						if(get_contact.get("id") != null)
						{
							...
							// 							contactMap.put("Type_de_contact",ifnull(subforms.get("Type_of_contact_123"),""));
						...
						if(getCreatorContact.get("code") == 3000)
						{
							if(getCreatorContact.get("data").size() > 0)
							{
								...
								// 								data_map.put("Type_of_contact1",ifnull(subforms.get("Type_of_contact_123"),""));
