...
<%
	...
	{
		%>
<div class="main_div_center page-border">
...
<%
		...
		if(fet_deal.Full_Name.isEmpty() != true)
		{
			...
			{
				%>
<div>Client 1:&nbsp;<span><%=deal.Client_ID.Full_Name%></span></div>
<%
			}
			else if(deal.Languages == "Anglais/English")
			{
				%>
<div>Customer 1:&nbsp;<span><%=deal.Client_ID.Full_Name%></span></div>
<%
			}
		}
...
<%
				...
				if(deal.Client_ID.Notes_Medication.isEmpty() != true)
				{
					%>
...
<%
			...
			if(fet_deal2.Date_of_Birth.isEmpty() != true)
			{
				...
				{
					%>
<div>Date de naissance:&nbsp;<span><%=fet_deal2.Date_of_Birth%></span></div>
<%
				}
				else if(deal.Languages == "Anglais/English")
				{
					%>
<div>Date of Birth:&nbsp;<span><%=fet_deal2.Date_of_Birth%></span></div>
<%
				}
			}
