...
<%
			...
			{
				%>
<div class="bgclr"><%=if(Language == "English",Translation_Master[Actual_Content == "CLIENT(E) 2/CLIENT 2"].English,Translation_Master[Actual_Content == "CLIENT(E) 2/CLIENT 2"].French)%></div>
<%
...
<%
						...
						{
							%>
<ul><li style="font-weight:bold;"><li style="font-weight:bold;"><%=if(Language == "English",Translation_Master[Actual_Content == "Notes d’hébergement/Accomodation notes"].English,Translation_Master[Actual_Content == "Notes d’hébergement/Accomodation notes"].French)%></li>
  <li style="text-align:justify;"><%=fet_deal.Notes_Accomodation%></li></ul>
<%
						}
						%>
