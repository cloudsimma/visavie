...
<%
		...
		if(itm.Image != null)
		{
			...
			if(!var.isEmpty())
			{
				img = "<img height=70px width=120px src='https://creatorexport.zoho.com/file/lion_visavie/visavie/All_Visavie_Profiles/" + itm.ID + "/Image/image-download/djbSN6PSp8wJVbHUy7bHYOTO2Y0rS6MwZB0a012FfdxSRXJTCAKGDVvaZR5qrM4UnQSbXAJCBNgsYGTThNVtnBSu1nfgtYZ0GgHC?filepath=/" + var + "'></img>";
			}
		}
		%>
...
<%
				...
				if(deal.Client_2.Preference_on_the_size_of_the_residence != null)
				{
					preference_list = List();
					for each  preference in deal.Client_2.Preference_on_the_size_of_the_residence
					{
...
<%
				...
				{
					%>
<div>Remarques - État neurocognitif/Notes - Neurocognitive State</div><div><span><%=deal.Client_2.Notes_Neurocognitive_State%></span></div>
<%
				}
				%>
</div>
