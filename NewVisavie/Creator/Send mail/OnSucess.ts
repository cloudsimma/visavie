try 
{
		...
		if(getRes.ID != null)
		{
			...
			if(getDealRes.count() > 0)
			{
				...
				[
					...
					Profile_Sent_Date=zoho.currentdate
	...
	else
	{
		if(deal.Client_ID != null)
		{
			link = "https://creatorapp.zohopublic.com/lion_visavie/visavie/page-perma/Deal_Client_1_New/xQhvX7vQMe2JEOjDGpjCgSOAz0JhMJXjsWYtT10dO0fbgXrW6gUNS5Fxm36PWN1DHmszRsmCzFHxNbOsBDB3dUZapuywFR0sbbW2?DealCRMId=" + input.Deal_ID.CRM_Deal_ID;
			pageUrl1 = "https://creatorapp.zohopublic.com/lion_visavie/visavie/pdf/Deal_Client_1_New/xQhvX7vQMe2JEOjDGpjCgSOAz0JhMJXjsWYtT10dO0fbgXrW6gUNS5Fxm36PWN1DHmszRsmCzFHxNbOsBDB3dUZapuywFR0sbbW2?DealCRMId=" + input.Deal_ID.CRM_Deal_ID.toLong() + "&isc5page=true&zc_FileName=" + input.Deal_ID.Client_ID.Full_Name;
			getPageUrl1 = invokeurl
			[
				url :pageUrl1
				type :GET
		...
		if(deal.Client_2 != null)
		{
			link = "https://creatorapp.zohopublic.com/lion_visavie/visavie/page-perma/Deal_Client2_New/8HquyArWHupa4h2OwRdPgk0UQDam9UHQ2vNsS6qbOWvF04famNUjTduerzM09s3qu5d1ssEVaO1XjDJdk9Xtvwq3w88RPH0VCqYk?DealCRMId=" + input.Deal_ID.CRM_Deal_ID;
			pageUrl2 = "https://creatorapp.zohopublic.com/lion_visavie/visavie/pdf/Deal_Client2_New/8HquyArWHupa4h2OwRdPgk0UQDam9UHQ2vNsS6qbOWvF04famNUjTduerzM09s3qu5d1ssEVaO1XjDJdk9Xtvwq3w88RPH0VCqYk?DealCRMId=" + input.Deal_ID.CRM_Deal_ID.toLong() + "&isc5page=true&zc_FileName=" + input.Deal_ID.Client_2.Full_Name;
			getPageUrl2 = invokeurl
			[
				url :pageUrl2
				type :GET
	...
	if(input.Contact_Email != null)
	{
		...
		if(contact_lst.size() > 0)
		{
			...
			if(input.Deal_ID != null)
			{
				...
				//		deal_list = Deal_Residences[Deals_bidirectional_lookup == input.Deal_ID].ID.getall();
				deal_list = Deal_Residences[Deals_bidirectional_lookup == input.Deal_ID];
				deal_id_list = list();
				...
				openUrl("https://creatorapp.zoho.com/lion_visavie/visavie/#Page:All_Residance?ID=" + deal_id_list + "&UserID=lion@visavie.com","same window");
			}
		}
	}
	if(input.Deal_ID != null)
