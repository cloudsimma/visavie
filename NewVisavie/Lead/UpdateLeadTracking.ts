try 
{
	...
	if(getLead.get("id") != null)
	{
		...
		// 		Existing_Health_info = getLead.get("Healthcare_Contact1");
		// 		if(getLead.get("Healthcare_Contact1") == null)
		// 		{
		// 			info "yes" ;
		// 			getlinkContact = zoho.crm.searchRecords("LeadXHospitalContact","(Hospital_contact:equals:" + getLead.get("id") + ")");
		// 			if(getlinkContact.size() > 0)
		// 			{
		// 				for each  rec in getlinkContact
		// 				{
		// 					if(rec.get("id") != null)
		// 					{
		// 						/* delete*/
		// 						deleteRecordMap = Map();
		// 						deleteRecordMap.put("module","LeadXHospitalContact");
		// 						deleteRecordMap.put("id",rec.get("id"));
	...
	if(getLead.get("id") != null && getLead.get("Tracking_Id") != null)
	{
		...
		{
			dataMap.put("Counselor_ID","");
			dataMap.put("Counselor_name","");
			dataMap.put("Counselor_User","");
		}
		...
		{
			dataMap.put("Temporary_Counselor_ID","");
			dataMap.put("Temporary_Counselor_name","");
			dataMap.put("Temporary_User","");
		}
		/* Lead Information*/
		...
		{
			dataMap.put("Lead_Hospital",null);
			dataMap.put("Lead_Hospital_ID",null);
			dataMap.put("Lead_Hospital_Branch",null);
			dataMap.put("Lead_Hospital1",null);
		}
		updateLeadTracking = zoho.crm.updateRecord("Tracking",getLead.get("Tracking_Id").toNumber(),dataMap);
		info updateLeadTracking;
	}
}
catch (e)
{
	...
	dataMap.put("Process_Description","CRM: Update Lead Tracking Record");
