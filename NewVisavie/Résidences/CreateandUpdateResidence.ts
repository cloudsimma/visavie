try 
{
	...
	if(Residence_info.get("id") != null)
	{
		...
		if(getData.get("code") == 3000)
		{
			...
			datamap.put("Type_of_residence",Residence_info.get("Type_of_residence"));
			...
			//Facturation/Billing
			datamap.put("Billing_Address",Residence_info.get("Adress_Adresse_1"));
			datamap.put("Method_of_sending",Residence_info.get("Method_of_sending_invoicing"));
			datamap.put("Billing_postal_code",Residence_info.get("Postal_codes_Code_postal"));
			datamap.put("Billing_province",Residence_info.get("Provinces"));
			datamap.put("Billing_main_phone",Residence_info.get("Primary_phones_T_l_phone_principal"));
			datamap.put("Billing_City",Residence_info.get("City_Ville"));
			...
			datamap.put("Notes_meal",Residence_info.get("Meal_Notes1"));
